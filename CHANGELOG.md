...
### Added
  ...
  - user can apply linear `MeanValueRestriction` or `CoupledDofsRestriction` to the `ProblemDescription` by `apply_restriction!()`
  - Incorporated new restriction objects in examples 252, 312 and 212.
