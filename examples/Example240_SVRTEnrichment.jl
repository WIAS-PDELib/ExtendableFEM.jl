...
function main(; nrefs = 5, μ = 1, α = 1, order = 2, Plotter = UnicodePlots, enrich = true, reduce = true, time = 0.5, bonus_quadorder = 5, kwargs...)
    ...
    ## prepare plots
    plt = GridVisualizer(; Plotter = Plotter, layout = (1, 3), clear = true, size = (960, 300))
